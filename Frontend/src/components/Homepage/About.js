        ...
        <Row className='mt-5 mb-5'>
            <Col md={6}>
                <div className='about_us__content'>
                    ...
                    <p>Investing has become an over-complicated affair – the Wall Street crowd loves it that way and profits accordingly.  But we aim to distill all the investment noise to its core essentials, yet still provide you with the necessary tools to make a wise decision. How do we know how to do this? </p>
